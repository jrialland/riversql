...
import com.riversql.plugins.oracle.SequenceTypeNode;
...
public class Sequences {
    ...
    public JSONObject execute() throws Exception {
        ...
        SequenceTypeNode seqTypeNode = (SequenceTypeNode) obj;
        ResultSet rs = null;
        ...
        try {
            ...
            ps = seqTypeNode.getConn().prepareStatement(sql);
            String owner = seqTypeNode.getParent().getName();
