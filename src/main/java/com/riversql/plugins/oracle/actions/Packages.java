...
import com.riversql.plugins.oracle.PackageTypeNode;
...
public class Packages {
    ...
    public JSONObject execute() throws Exception {
        ...
        PackageTypeNode packageTypeNode = (PackageTypeNode) obj;
        ResultSet rs = null;
        ...
        try {
            ...
            ps = packageTypeNode.getConn().prepareStatement(sql);
            String owner = packageTypeNode.getParent().getName();
