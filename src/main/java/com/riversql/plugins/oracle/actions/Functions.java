...
import com.riversql.plugins.oracle.FunctionTypeNode;
...
public class Functions {
    ...
    public JSONObject execute() throws Exception {
        ...
        try {
            ...
            ps = functionTypeNode.getConn().prepareStatement(sql);
            String owner = functionTypeNode.getParent().getName();
