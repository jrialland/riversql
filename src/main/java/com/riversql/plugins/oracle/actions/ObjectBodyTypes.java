...
import com.riversql.plugins.oracle.ObjectTypeBodyNode;
...
public class ObjectBodyTypes {

    private String id;

    public ObjectBodyTypes(String id) {
        this.id = id;
    }
    ...
    public JSONObject execute() throws Exception {
        ...
        ObjectTypeBodyNode objTypeNode = (ObjectTypeBodyNode) obj;
        ResultSet rs = null;
        ...
        try {
            ...
            ps = objTypeNode.getConn().prepareStatement(sql);
            String owner = objTypeNode.getParent().getName();
