...
import com.riversql.plugins.oracle.DirectoryTypeNode;
...
public class Directories {
    ...
    public JSONObject execute() throws Exception {
        ...
        DirectoryTypeNode lNode = (DirectoryTypeNode) obj;
        ResultSet rs = null;
        ...
        try {
            ...
            ps = lNode.getConn().prepareStatement(sql);
            String owner = lNode.getParent().getName();
