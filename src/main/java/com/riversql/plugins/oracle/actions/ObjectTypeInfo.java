...
import com.riversql.plugins.oracle.ObjectNode;
import org.slf4j.LoggerFactory;


public class ObjectTypeInfo {
	String id;
	public ObjectTypeInfo(String id) {
		this.id=id;
	}
	...
	public JSONObject execute()throws Exception {
		...
		ObjectNode funz=(ObjectNode)obj;
		final String sql=
		"SELECT  a.created,a.last_ddl_time, a.timestamp, a.status,"+
		" b.predefined, b.incomplete, b.final, b.instantiable, b.typecode "+
		 " FROM sys.all_objects a,sys.all_types b where a.owner=? and a.object_type='TYPE' and object_name=? and b.owner=a.owner "+
